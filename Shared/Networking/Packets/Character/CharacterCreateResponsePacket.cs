...
namespace Shared.Networking.Packets.Character
{
    ...
    /// </remarks>
    public readonly struct CharacterCreateResponsePacket : IPacketWritable
    {
        /// <summary>
        ...
        /// </summary>
        public CharacterCreateOutcome Outcome { get; }
        ...
        public CharacterCreateResponsePacket(CharacterCreateOutcome outcome)
        {
            Outcome = outcome;
        }
