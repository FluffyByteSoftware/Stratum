...
namespace Stratum.Shared.Networking.Packets.LifeCycle
{
    /// <summary>
    /// Represents a Pong packet containing an echoed timestamp from a Ping request.
    /// </summary>
    public readonly struct PongPacket : IPacketWritable
    {
        /// <summary>
        ...
        public long EchoedTimestampMs { get; }
        ...
        public PongPacket(long echoedTimestampMs)
        {
            EchoedTimestampMs = echoedTimestampMs;
        }
