...
/// <summary>
/// Represents a TCP network connection with thread-safe disconnect management and resource cleanup.
/// </summary>
/// <param name="id">The unique identifier for the connection.</param>
/// <param name="client">The TCP client associated with the connection.</param>
